...
const DISSONANCE_OPTIONS_HTML = `
  ...
  <div class="checkbox-group" style="margin:0; gap:6px;">
    ...
    <div class="cb-row" style="gap:6px;"><input type="checkbox" id="tree-x4" style="width:14px;height:14px;"  onchange="calc()"><label for="tree-x4">X4 Factor</label><input type="number" id="tree-x4-value" min="0" max="9" step="0.1" value="9" style="width:50px;" onInput="clamp(this); calc()"><span class="tip"><span class="tip-icon">i</span><span class="tip-box"><span class="highlight-gold">Input the % in the factor tooltip NOT THE LEVEL.</span> X% MATK (changed from MAG Boost in s3)</span></span></div>
    ...
    <div class="cb-row" style="gap:6px;"><input type="checkbox" id="tree-x10" style="width:14px;height:14px;"  onchange="calc()"><label for="tree-x10">X10 Factor</label><input type="number" id="tree-x10-value" min="0" max="370" step="0.1" value="370" style="width:50px;" onInput="clamp(this); calc()"><span class="tip"><span class="tip-icon">i</span><span class="tip-box"><span class="highlight-gold">Input the % in the factor tooltip NOT THE LEVEL.</span> X INT when above 80% hp.</span></span></div>
